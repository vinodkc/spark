...
class MergingSessionsEvaluatorFactory(
  ...
  override def createEvaluator(): PartitionEvaluator[InternalRow, InternalRow] =
    new MergingSessionsEvaluator

  private class MergingSessionsEvaluator extends PartitionEvaluator[InternalRow, InternalRow] {
    override def eval(
        partitionIndex: Int,
