...
-- SHOW TABLES AS JSON
SHOW TABLES AS JSON;
SHOW TABLES IN showdb AS JSON;

-- SHOW TABLES AS JSON WITH wildcard match
SHOW TABLES 'show_t*' AS JSON;
SHOW TABLES LIKE 'show_t1*|show_t2*' AS JSON;
SHOW TABLES IN showdb 'show_t*' AS JSON;
SHOW TABLES IN showdb LIKE 'show_t*' AS JSON;

-- SHOW TABLE EXTENDED AS JSON
SHOW TABLE EXTENDED LIKE 'show_t*' AS JSON;

-- SHOW TABLE EXTENDED AS JSON ... PARTITION
SHOW TABLE EXTENDED LIKE 'show_t1' PARTITION(c='Us', d=1) AS JSON;
