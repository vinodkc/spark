...
@ExpressionDescription(
  ...
  arguments = """
    Arguments:
      ...
      * format - Time format pattern to follow.
  """,
  examples = """
    Examples:
...
@ExpressionDescription(
  ...
  """,
  note = """
    Time format patterns are a subset of datetime patterns. Date-related patterns (y, M, d, etc.)
    will produce fixed values (epoch date: 1970-01-01) if used with TIME values.
  """,
  group = "datetime_funcs",
  since = "4.2.0")
// scalastyle:on line.size.limit
